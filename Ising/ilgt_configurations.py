#-------------------------------------------------------------------------------
# Filename: ilgt_configurations.py
...
if training_data: 
    np.save("ilgt_training_configs.npy", configs)
    np.save("ilgt_training_labels.npy", labels)
else: 
    np.save("ilgt_test_configs.npy", configs)
    np.save("ilgt_test_labels.npy", labels)
